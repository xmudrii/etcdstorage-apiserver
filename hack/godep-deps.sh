...
mkdir -p ${goPath}/src/github.com/xmudrii/etcdstorage-apiserver
cp -R . ${goPath}/src/github.com/xmudrii/etcdstorage-apiserver

pushd ${goPath}/src/github.com/xmudrii/etcdstorage-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/github.com/xmudrii/etcdstorage-apiserver/vendor .
mv ${goPath}/src/github.com/xmudrii/etcdstorage-apiserver/Godeps .
git add vendor
git add Godeps
