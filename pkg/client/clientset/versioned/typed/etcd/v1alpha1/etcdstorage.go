...
import (
	...
	scheme "github.com/xmudrii/etcdstorage-apiserver/pkg/client/clientset/versioned/scheme"
...
func newEtcdStorages(c *EtcdV1alpha1Client, namespace string) *etcdStorages {
	return &etcdStorages{
		client: c.RESTClient(),
		ns:     namespace,
	}
