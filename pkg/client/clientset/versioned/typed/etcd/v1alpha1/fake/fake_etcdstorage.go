...
import (
	v1alpha1 "github.com/xmudrii/etcdstorage-apiserver/pkg/apis/etcd/v1alpha1"
...
var etcdstoragesResource = schema.GroupVersionResource{Group: "etcd.k8s.io", Version: "v1alpha1", Resource: "etcdstorages"}

var etcdstoragesKind = schema.GroupVersionKind{Group: "etcd.k8s.io", Version: "v1alpha1", Kind: "EtcdStorage"}
...
func (c *FakeEtcdStorages) Get(name string, options v1.GetOptions) (result *v1alpha1.EtcdStorage, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(etcdstoragesResource, c.ns, name), &v1alpha1.EtcdStorage{})
...
func (c *FakeEtcdStorages) List(opts v1.ListOptions) (result *v1alpha1.EtcdStorageList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(etcdstoragesResource, etcdstoragesKind, c.ns, opts), &v1alpha1.EtcdStorageList{})
...
func (c *FakeEtcdStorages) Create(etcdStorage *v1alpha1.EtcdStorage) (result *v1alpha1.EtcdStorage, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(etcdstoragesResource, c.ns, etcdStorage), &v1alpha1.EtcdStorage{})
...
func (c *FakeEtcdStorages) Update(etcdStorage *v1alpha1.EtcdStorage) (result *v1alpha1.EtcdStorage, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(etcdstoragesResource, c.ns, etcdStorage), &v1alpha1.EtcdStorage{})
...
func (c *FakeEtcdStorages) UpdateStatus(etcdStorage *v1alpha1.EtcdStorage) (*v1alpha1.EtcdStorage, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(etcdstoragesResource, "status", c.ns, etcdStorage), &v1alpha1.EtcdStorage{})
...
func (c *FakeEtcdStorages) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(etcdstoragesResource, c.ns, name), &v1alpha1.EtcdStorage{})
...
func (c *FakeEtcdStorages) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.EtcdStorage, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(etcdstoragesResource, c.ns, name, data, subresources...), &v1alpha1.EtcdStorage{})
