...
// List lists all EtcdStorages in the indexer for a given namespace.
func (s etcdStorageNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.EtcdStorage, err error) {
...
// Get retrieves the EtcdStorage from the indexer for a given namespace and name.
func (s etcdStorageNamespaceLister) Get(name string) (*v1alpha1.EtcdStorage, error) {
